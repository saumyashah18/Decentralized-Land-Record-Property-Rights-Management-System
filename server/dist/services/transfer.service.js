...
class TransferService {
    ...
    async transferAsset(assetId, newOwnerId, user) {
        ...
        const { gateway, contract } = await (0, gateway_1.getFabricContract)('mychannel', 'TransferContract', user);
        try {
            await contract.submitTransaction('TransferAsset', assetId, newOwnerId, hash);
